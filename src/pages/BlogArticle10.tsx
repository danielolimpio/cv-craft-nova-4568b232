...
const BlogArticle10 = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Currículo para Estágio: Guia Definitivo ✓ Estudantes</title>
        <meta name="description" content="Estudante buscando estágio? Monte um currículo que destaca formação, projetos acadêmicos e habilidades — mesmo sem experiência. Modelo pronto + dicas!" />
