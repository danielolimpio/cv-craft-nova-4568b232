...
const BlogArticle11 = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Currículo vs LinkedIn 2026: Qual Usar e Quando? ✓</title>
        <meta name="description" content="Currículo ou LinkedIn — qual o recrutador olha primeiro? Descubra quando priorizar cada um e como alinhar os dois para máximo impacto na sua carreira." />
